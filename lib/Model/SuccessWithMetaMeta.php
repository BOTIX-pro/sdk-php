...
/**
 * SuccessWithMetaMeta Class Doc Comment
 *
 * @category Class
 * @package  BotixPro\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class SuccessWithMetaMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SuccessWithMeta_meta';
     ...
     * Sets page
     *
     * @param int|null $page Только в page-режиме
     *
     * @return self
     */
     ...
     * Sets per_page
     *
     * @param int|null $per_page Только в page-режиме
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total Только в page-режиме
     *
     * @return self
     */
     ...
     * Sets next_cursor
     *
     * @param string|null $next_cursor v1.1+. В cursor-режиме — токен для следующей страницы. null = последняя страница. В page-режиме отсутствует.
     *
     * @return self
     */
     ...
     * Sets has_more
     *
     * @param bool|null $has_more v1.1+. true если есть ещё страницы (cursor-режим).
     *
     * @return self
     */
