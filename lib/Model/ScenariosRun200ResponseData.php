...
/**
 * ScenariosRun200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  BotixPro\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ScenariosRun200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'scenariosRun_200_response_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('first_block', $data ?? [], null);
        $this->setIfExists('first_blocks', $data ?? [], null);
    }
     ...
     * Sets first_block
     *
     * @param object|null $first_block Первый рендер сценария (widget-канал — заполнено; tg/vk — пусто).
     *
     * @return self
     */
    public function setFirstBlock($first_block)
    {
        if (is_null($first_block)) {
            array_push($this->openAPINullablesSetToNull, 'first_block');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('first_block', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        return $this->container['first_blocks'];
    }

    /**
     * Sets first_blocks
     *
     * @param object[]|null $first_blocks first_blocks
     *
     * @return self
     */
    public function setFirstBlocks($first_blocks)
    {
        if (is_null($first_blocks)) {
            throw new \InvalidArgumentException('non-nullable first_blocks cannot be null');
        }
        $this->container['first_blocks'] = $first_blocks;
